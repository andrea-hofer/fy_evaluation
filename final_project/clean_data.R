# This file cleans the data set. It removes the test run data, replaces special characters
# and recodes variables with non numeric anserws to numeric answers.
# It is called by the pdf_output.Rmd file and does not need to be executed separately.
...
## Delete first two rows as they were just test runs:
#  Do this by ordering the data set according to the data and drop the first two dates (=rows)
#  Convert Timestamp into date and drop
## @knitr drop_testrun
fy_df = fy_df[3:15,]
