# This file downloads the data from google forms and saves them in a newly created input folder for Mac users.

# IMPORTANT:
#       in order for the file to work, the right path to the users chromedriver needs to be manually
#       filled in on line 43, (e.g. chromedriver = '/Users/andrho/Downloads/chromedriver')
# coding: utf-8
...
# Create input and output folder in current directory
...
chromedriver = '/Users/andrho/Downloads/chromedriver'
